...
NPCToonDict = {
 ...
 7010: (-1, lnames[7010], ('dll', 'ms', 'm', 'm', 2, 0, 2, 2, 19, 10, 13, 10, 7, 14), 'm', 0, NPC_REGULAR),
...
HQnpcFriends = {
 ...
 7010: (ToontownBattleGlobals.NPC_RESTOCK_GAGS, ToontownBattleGlobals.TRAP_TRACK, 3, 10, 5)
 }
