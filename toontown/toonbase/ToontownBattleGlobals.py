...
AvPropDamage = (
 ...
 ( # Sound
  ...
  ((8, 12), (Levels[3][1], Levels[3][2])),
  ((15, 22), (Levels[3][2], Levels[3][3])),
  ((24, 26), (Levels[3][3], Levels[3][4])),
  ((39, 42), (Levels[3][4], Levels[3][5])),
  ((45, 90), (Levels[3][5], Levels[3][6])),
  ((132, 132), (Levels[3][6], MaxSkill))
 ),
 ( # Throw
  ((11, 20), (Levels[4][0], Levels[4][1])),
  ((25, 30), (Levels[4][1], Levels[4][2])),
  ((35, 40), (Levels[4][2], Levels[4][3])),
  ((50, 65), (Levels[4][3], Levels[4][4])),
  ((70, 80), (Levels[4][4], Levels[4][5])),
  ((90, 100), (Levels[4][5], Levels[4][6])),
  ((140, 140), (Levels[4][6], MaxSkill))
 ),
 ( # Squirt
  ((7, 14), (Levels[5][0], Levels[5][1])),
  ((20, 30), (Levels[5][1], Levels[5][2])),
  ((40, 50), (Levels[5][2], Levels[5][3])),
  ((55, 60), (Levels[5][3], Levels[5][4])),
  ((65, 85), (Levels[5][4], Levels[5][5])),
  ((48, 100), (Levels[5][5], Levels[5][6])),
  ((140, 140), (Levels[5][6], MaxSkill))
 ),
 ( # Drop
