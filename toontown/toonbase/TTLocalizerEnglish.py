...
MovieHealLaughterMisses = ('hmm',
 ...
 'ha',
 'harr harr',
 'Wait was that supposed to make me laugh?')
...
TrackPageClear = 'You are not training any Gag Tracks right now.\nWhen you want to train a gag you must be in DD,MML,TTC, or TB'
...
PatternGameTitle = 'Match Tech Bot'
PatternGameInstructions = 'Tech Bot will show you a dance sequence. ' + "Try to repeat Tech Bot's dance just the way you see it using the arrow keys!"
...
SkelecogInvasionBegin = [
 "This just in, Sellbot HQ's factory has gone bonkers!",
...
V2InvasionBegin = [
 "Oh my, might want stock up on gags toons!",
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'You can have up to 400 friends on your Friends List. You start at 50 however you can upgrade it thourgh a series of toontasks.',
               ...
               'Go to your estate and play with your pet doodle if you are getting low on health or dont have Toon-Up they come in handy during battles.',
               ...
               'For every 10 species you catch, you will get a fishing trophy and a laff boost!',
			   ...
			   'you can report a bug by contacting Tech Bot or report bugs in the #tts-bugs channel.'),
 TIP_STREET: ('There are four types of Cogs: Lawbots, Cashbots, Sellbots, and Bossbots.',
              ...
              'On the streets, side doors tell knock-knock jokes when approached. \nThey will also give you a small laff boost to help you last longer while fighting the evil cogs',
 ...
 TIP_MINIGAME: ('After you fill up your Jellybean jar, any Jellybeans you get from Trolley Games automatically spill over into your bank.',
                'You can use the arrow keys instead of the mouse in the "Match Tech Bot" Trolley Game.',
...
SummonDlgButton7 = 'Summon a version 3.0 Invasion'
...
SummonDlgV3InvasionConf = 'Would you like to summon a Version 3.0 %s invasion?'
...
LaserGameMine = 'Mine Sweeper!'
LaserGameRoll = 'Matching'
LaserGameAvoid = 'Avoid the Skulls'
LaserGameDrag = 'three of a kind'
...
BossbotRewardSpeech1 = "You will never win toons!."
BossbotRewardSpeech2 = 'MWHAHAHAHA!!!!'
...
ElevatorBossBotCourse3 = 'The full 18'
