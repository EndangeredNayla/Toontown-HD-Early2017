...
class TTCodeRedemptionMgrAI(DistributedObjectAI):
    ...
    codes = {
        ...
        'donaldstatue': {
			...
			'NewYearsDay': {
			'items': [
				CatalogClothingItem.CatalogClothingItem(131,0)
	],
    'expirationDate': datetime(2017, 1, 1),
        },
			'yourawesome': {
			'items': [
				CatalogAccessoryItem.CatalogAccessoryItem(330, 0),
				CatalogClothingItem.CatalogClothingItem(1811, 0),
				CatalogClothingItem.CatalogClothingItem(1768, 0),
				CatalogClothingItem.CatalogClothingItem(1776, 0),
				CatalogClothingItem.CatalogClothingItem(1777, 0),
				CatalogClothingItem.CatalogClothingItem(1782, 0)
	],
    'expirationDate': datetime(2017, 3, 7)
		}
	}
